...
@Component({
  selector: 'app-student-course-page-header-small',
  templateUrl: './student-course-page-header-small.component.html',
  styleUrls: ['./student-course-page-header-small.component.css']
})
export class StudentCoursePageHeaderSmallComponent implements OnInit {
  key: string;
  colorNum: number;
  sub: any;
  course: any;
